...
class Subkriteria extends CI_Controller {
	...
	public function index()
	{
		...
		$data['result'] = $this->db->query("SELECT * FROM master_subkriteria ms
			...
			ms.imaster_kriteria = mk.imaster_kriteria")->result_array();
	...
	function save(){
		...
		$data['fnilai_range1'] = $this->input->post('fnilai_range1'); 
		$data['fnilai_range2'] = $this->input->post('fnilai_range2');  
	...
	function edit($id){
		...
		$data['fnilai_range1'] = $dt['fnilai_range1']; 
		$data['fnilai_range2'] = $dt['fnilai_range2']; 
		$data['btn'] = 'Edit'; 
		$this->template->load('template_wp','subkriteria/formsubkriteria', $data); 
	}
	function Ubah(){
