              ...
              <tr>
                ...
                <td width="30%">
                  ...
                  <?php 
                      ...
                      <input type="hidden" name="ialternatif_periode" value="'.$ialternatif_periode.'">
                      ';
                      }
                    }
                  ?>
          ...
          <tfoot>
            <tr>
              <td colspan="4">
                ...
                <a href="<?php echo base_url().'Alternatif/edit/'.$ialternatif_periode?>" class="btn-lg btn-warning">Back</a> 
              </td>  
            </tr>
          </tfoot>
        </table>
