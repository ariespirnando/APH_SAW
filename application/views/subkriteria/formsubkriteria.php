<div class="page-content">
	<div class="row">
        ...
        <table class="table table-striped table-bordered table-hover" width="90%">
          <tbody> 
            <tr>
              <th width="25%" class="center">Nama Kriteria</th> 
            ...
            <tr>
              <th width="25%" class="center">Nama Sub Kriteria</th> 
              <th width="65%" colspan="2">
            ...
            <tr>
              <th width="25%" class="center" rowspan="2">Range</th> 
              <th width="32%">
                Awal
              </th>  
              <th width="32%">
            ...
            <tr> 
              <th width="32%">
                <input type="text" name="fnilai_range1" value="<?php echo $fnilai_range1 ?>" class="angka2 form-control" required> 
              </th>  
              <th width="32%">
                <input type="text" name="fnilai_range2" value="<?php echo $fnilai_range2 ?>" class="angka2 form-control" required> 
              </th>  
            </tr>
