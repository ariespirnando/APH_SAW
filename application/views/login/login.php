<div class="page-content" style="background-image: url('<?php echo base_url() ?>assets/images/94495111-hello-sehat-1024x685.jpg');">
	<div class="row" >
		<br>
		<br>
		<div class="col-xs-4">
				...
				<div class="widget-box">  
				 <div class="widget-body">
					...
					<br>
								 ...
								 <a href="<?php echo base_url().'Daftar'?>" class="btn-lg btn-warning">Daftar</a>
								 <br>
							 </fieldset>
						 </form>
					 </div>
